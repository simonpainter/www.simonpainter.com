...
<!-- truncate -->
![What's this all about then?](img/egress-ip-decision-tree/decision-tree-load-balancer-thumb.png)
...
![This makes sense](img/egress-ip-decision-tree/egress-test-vm.png)
...
![This also makes sense](img/egress-ip-decision-tree/egress-test-nat-pip.png)
