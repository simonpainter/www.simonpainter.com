...
> It's important to call out here that the NSG is for the appliance subnet and not for the appliance NICs. I had a [question on reddit](https://www.reddit.com/r/AZURE/comments/1r3wlnd/comment/o5btw1a/) about if the NSG applied to the appliance could be used to control the traffic between spokes. You can control traffic between the spokes using an NSG on the appliance subnet. NSGs are a blunt tool because even though they are stateful you still have to apply the rule in two directions because the traffic is coming in and going out of the subnet.
