...
If you're using Cloudflare in proxied mode, it's probably already publishing HTTPS records for you. If you want to set this up for your own domain, here are the steps:
