...
If you want the longer version, I wrote up a fuller take on what changed at GA and where it fits in a hub design in [Azure Virtual Network Routing Appliance goes GA](/azure-virtual-network-routing-appliance-ga). That post also carries a correction: I originally said VNRA couldn't carry a default route to a firewall, and it can.
